...
At the end of Q2 2026, we estimate approximately \textbf{7.8~GW of operational AI
compute} (Tier~1; revised from 8.2~GW after the 2026-04-22 Stargate Abilene schedule slip
reclassified 0.4~GW to Tier~2). Announced commitments through 2030 imply a \textbf{raw
horizon of 50.6~GW} across Western-aligned operators. Under our realization-probability framework
(T1 at 100\% through T6 at 25\%) the deterministic tier-weighted point estimate is
approximately \textbf{36~GW}; however, a 10,000-draw Monte Carlo that samples tier
realization rates from tier-fitted Beta distributions and applies the five stress
scenarios (\S\ref{subsec:stress-matrix}) with their prior probabilities produces a
\textbf{median 2030 realized horizon of approximately 31~GW} with an
\textbf{interdecile range of [24, 37]~GW} --- our probability-honest central estimate.
Our \textbf{conservative case} (Tiers 1+2+3 only) is approximately \textbf{28~GW};
our \textbf{full-realization ceiling} is approximately \textbf{53.5~GW}. The associated
capital envelope is approximately \textbf{\$1.2--1.5 trillion}, distinct from the
approximately \textbf{\$550~billion} in contracted remaining performance obligations
(RPO) that underwrites it. A separate approximately \textbf{2~GW} sovereign-AI pipeline
in the UAE, Saudi Arabia, India, and the UK is reported as a sidebar. Every cited
number is paired with an evidence tier (T1--T6) and resolvable to a row in the companion
...
Data cutoff: April 24, 2026\quad\textbullet\quad Publication: April 24, 2026 (revision 2)\\[2pt]
Primary data: Epoch AI, \emph{Frontier Data Centers} (snapshot 2026-04-24, incorporating the 2026-04-22 changelog revision to Stargate Abilene and the 2026-04-10 revision to Meta Prometheus).\footnote{Epoch AI, \emph{Frontier Data Centers} dataset and changelog, retrieved April 24, 2026. \url{https://epoch.ai/data/data-centers}. Methodology (\url{https://epoch.ai/data/data-centers-documentation}) discloses that cooling-model power estimates can in principle vary by up to a factor of 2 against ground truth, though Epoch's validation against known-capacity sites shows agreement within approximately 50\%; capital-cost estimates apply a uniform \$44~B/GW (\$30~B hardware + \$14~B infrastructure) and do not vary by site. These bands are consistent with our T2 realization-probability range of 80--95\% and the T3 range of 65--90\% and provide external validation for the six-tier prior framework.} Supplementary disclosures cited in footnotes throughout.\\[2pt]
\emph{Rev-2 changes (2026-04-24).} Stargate Abilene operational reclassified 0.40~GW from T1 (operational) to T2 (physically-evidenced / under construction) per Oracle disclosure of ~200~MW operational on April~22 (prior figure assumed the 600~MW April-1 milestone; Epoch now shows that milestone in late May 2026 with Buildings 7--8 in November). Meta Prometheus H100e full-buildout ceiling revised from 1.2M to 1.0M after Epoch excluded five production DCs and the first tent building (retrofit-only / non-AI use). Operational-today falls from 8.2~GW to 7.8~GW; 2030 Western H100e falls from 78.4M to 78.2M; probability-weighted 2030 falls from 36.1 to 36.1~GW (the shift is within the conservative T1+T2+T3 envelope so the bear case of 27.8~GW is unchanged). Monte Carlo re-run with the revised tier partition produces a median of 31.2~GW versus the prior 31.3~GW --- the shift is smaller than the rounding error on the previous figure.
}
\end{center}
...
\textcolor{softGrey}{1.} & The scale of what is being built & 3 \\
\textcolor{softGrey}{2.} & Geographic concentration & 7 \\
\textcolor{softGrey}{3.} & The operators: who owns the horizon & 9 \\
\textcolor{softGrey}{4.} & The silicon: NVIDIA, Trainium, TPU, AMD, Broadcom, MTIA & 12 \\
\textcolor{softGrey}{5.} & The \$1.5 trillion question: where the money comes from & 15 \\
\textcolor{softGrey}{6.} & The counterparty graph & 19 \\
\textcolor{softGrey}{7.} & Execution risk: what breaks the build-out & 22 \\
\textcolor{softGrey}{8.} & Sovereign AI & 25 \\
\textcolor{softGrey}{9.} & Known unknowns & 26 \\
\textcolor{softGrey}{10.} & Conclusion & 28 \\
\textcolor{softGrey}{A.} & Appendix: data sources and methodology & 29 \\
...
In Q2 2026, the operational AI compute fleet worldwide totals approximately \textbf{7.8~GW} of IT-power (Tier~1), corresponding to approximately \textbf{4.2~million H100-equivalent chips}.\footnote{Epoch AI, \emph{Frontier Data Centers} dataset, snapshot April 24, 2026, incorporating the 2026-04-22 changelog entry revising Stargate Abilene from a 600~MW April-1 milestone to ~200~MW actual operational. H100-equivalent (H100e) normalizes GPU throughput by 8-bit operations per second relative to the NVIDIA H100 baseline. \url{https://epoch.ai/data/data-centers}} Announced commitments through 2030 across the same operators --- hyperscalers, frontier labs, and the independent neoclouds --- imply a raw \textbf{50.6~GW} horizon across the Western-aligned operator set, with a further approximately \textbf{2~GW} in the sovereign-AI sidebar. Under tier-default probability weighting, the expected 2030 realization is approximately \textbf{36~GW}; the T1+T2+T3 conservative case is approximately \textbf{28~GW}; and the full-realization ceiling is approximately \textbf{53.5~GW}.

\textbf{The central fact} is that 85\% of the 50.6~GW raw 2030 horizon is not yet operational (up from 84\% pre-rev-2, after the Stargate Abilene T1$\rightarrow$T2 reclassification); on a probability-weighted basis, the expected realization of approximately 36~GW leaves approximately 78\% still to build, and the Monte Carlo median of approximately 31~GW (\S\ref{subsec:monte-carlo}) implies that even under a probabilistically-honest reading approximately 75\% of the 2030 horizon remains to be built. The AI compute stack of the late 2020s is overwhelmingly a forward commitment, not an in-place fleet.
...
\begin{axis}[
  ...
  xlabel={Year-end}, ylabel={Cumulative GW (IT power)},
...
\addplot[color=accentOchre,line width=1.2pt,mark=square*,mark size=1.7pt,mark options={fill=accentOchre}] coordinates {
  (2023, 0.2) (2024, 1.8) (2025, 6.6) (2026, 17.3)
  (2027, 30.1) (2028, 46.2) (2029, 49.1) (2030, 50.6)
};
...
% Horizontal reference line at today's operational level
\addplot[color=accentSage,dashed,line width=0.7pt,forget plot] coordinates {(2023,7.76) (2030,7.76)};
\node[color=accentSage,font=\scriptsize,anchor=west] at (axis cs:2023.1,9.2) {Operational today: 7.76 GW (rev-2 post-Abilene-slip)};
\end{axis}
\end{tikzpicture}
\caption{Cumulative AI compute capacity, 2023--2030. \textbf{Unit:} GW of IT power (PUE 1.20 baseline; see \S\ref{subsec:power-units} for sensitivity). \textbf{Included:} Epoch-tracked sites (blue); Class~A overlay + neocloud-ex-Epoch (ochre). \textbf{Excluded:} Class~B chip-procurement GW that deploys into existing shells; sovereign sidebar (reported separately in \S8). \textbf{Epistemic status:} blue is T1+T2 realized + T2/T3 near-term; ochre is the raw announced horizon (unweighted sum of T1--T5). The probability-weighted horizon (approximately 36.1~GW at 2030) sits between the two lines at the right edge. \textbf{What moves it:} stress scenarios A--D in \S\ref{subsec:stress-matrix} each shift the 2030 point by 1.5--8~GW.\protect\footnotemark}
\end{figure}
...
Every gigawatt figure in this paper is an IT-equivalent gigawatt --- the heat-load delivered to the accelerators themselves, not the total facility power at the utility meter. This choice is driven by what operators and Epoch AI disclose most consistently, but the reader should keep five distinct power concepts in mind:
...
\textbf{Conversion policy.} Epoch AI's \emph{Frontier Data Centers} dataset reports power at IT load where disclosed (the dominant case) or at facility power flagged with a disclosure note. Where the original commitment announcement states ``X gigawatts'' without specifying the basis, we apply the per-row \texttt{mw\_basis} field documented in the overlay YAML: \texttt{IT}, \texttt{facility}, \texttt{interconnection}, \texttt{cooling}, or \texttt{unknown}. For the 14 Class~A Western overlay commitments, 9 are classified IT-basis, 3 facility-basis (with PUE of 1.20 assumed for conversion), and 2 \texttt{unknown}. The conversion applies PUE~1.20 where basis is unspecified. Full per-row disclosure appears in Appendix~B.

\textbf{PUE sensitivity.} If the entire Western 2030 horizon were re-expressed as \emph{facility} power rather than IT power, the 50.6~GW point estimate would scale by the relevant PUE; if re-expressed as \emph{IT} power for commitments we currently carry at facility-basis, the number shrinks.
...
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{PUE assumption} & \textbf{Western 2030 GW (facility power)} & \textbf{Change vs.\ IT baseline} \\
\midrule
1.10 (aggressive liquid cooling) & 55.7 & +10.1\% \\
1.20 (paper baseline; Epoch convention) & 60.7 & +20.0\% \\
1.30 (typical hyperscale air/hybrid) & 65.8 & +30.1\% \\
1.50 (older hyperscale retrofits) & 75.9 & +50.0\% \\
1.60 (legacy colocation) & 80.9 & +60.0\% \\
\bottomrule
\end{tabular}
\caption{Western 2030 horizon expressed at facility power under five PUE assumptions. The 50.6~GW figure used elsewhere in this paper is IT-basis. Readers comparing against utility-contracted-MW datasets (e.g.\ EIA Form 861, FERC queue reports) should apply the relevant PUE; readers comparing against chip-nameplate aggregates (NVIDIA/Broadcom ``X~GW'' silicon commitments) can use the IT-basis number directly.}
\end{table}

A residual uncertainty band of roughly $\pm$15\% around the headline horizon is the honest reading once PUE disclosure heterogeneity is accounted for. Translation: 50.6~GW IT maps to $[43, 58]$~GW facility in the realistic PUE range 1.10--1.35 for modern builds, or $[56, 81]$~GW in the broader sensitivity range including legacy PUEs. The PUE range of 1.10--1.35 captures where every currently-announced frontier-AI campus operates at scheduled commissioning; we use it as the supported band.
...
By 2030 on an announced-horizon basis, the same operator set expands to approximately \textbf{50.6~GW} aggregate (raw); to approximately \textbf{36~GW} probability-weighted; and to approximately \textbf{28~GW} under the conservative T1+T2+T3 case. The three largest operators (Microsoft, Amazon-including-Anthropic, OpenAI-Stargate) each individually carry more than 10~GW of announced buildout --- with Amazon/Anthropic's 12.9~GW dominated by the T4 Anthropic expansion announcement (3.17~GW incremental at 72\% realization), OpenAI/Stargate's 10.6~GW dominated by T4 Stargate 8 sites (at a blended 70\% realization because Stargate is capex-secured but grid-interconnection-constrained), and Microsoft's 5.3~GW sitting largely at T2 (Fairwater construction visible) with realization probabilities near 85\%.
...
\begin{axis}[
  ...
  ytick=data,
  yticklabels={Western 2026--2030 capex},
  xlabel={\$ billions},
  xlabel style={font=\small,color=softGrey},
  yticklabel style={font=\small,color=inkBlack},
  xticklabel style={font=\small,color=softGrey},
  ...
  tick style={softGrey,thin},
  grid=major, grid style={paleGrey,dashed,very thin},
  legend style={at={(0.5,-0.4)},anchor=north,font=\footnotesize,draw=paleGrey,fill=lightCream,legend columns=2},
  legend cell align={left},
  nodes near coords,
  nodes near coords style={font=\footnotesize,color=white,align=center},
  every node near coord/.append style={/pgf/number format/.cd,fixed,precision=0},
]
\addplot[fill=chartA,draw=white] coordinates {(600,capex)};
\addlegendentry{Hyperscaler operating cash (MSFT, AMZN, GOOGL, META)}
\addplot[fill=chartB,draw=white] coordinates {(500,capex)};
\addlegendentry{Lab take-or-pay contracts (\$300B Oracle--OpenAI anchor)}
\addplot[fill=chartC,draw=white] coordinates {(150,capex)};
\addlegendentry{Neocloud debt (CoreWeave, Nebius, Applied Digital)}
\addplot[fill=chartD,draw=white] coordinates {(200,capex)};
\addlegendentry{Sovereign (MGX, HUMAIN, UK DSIT, RIL)}
\end{axis}
\end{tikzpicture}
\caption{The approximate \$1.45 trillion capital envelope, 2026--2030, broken by funding channel. The hyperscaler channel is self-funding from operating cash flow and carries no external credit risk; the take-or-pay channel transfers credit risk to the labs' ability to generate revenue; the neocloud-debt channel sits on hyperscaler-investment-grade counterparty credit via SPV structures; the sovereign channel runs on national-treasury backing. Channel sizing carries approximately $\pm$15\% uncertainty and is net of inter-channel overlaps (OpenAI's Oracle-facing spend is funded in part by OpenAI's equity rounds from MGX, for example).\protect\footnotemark}
\end{figure}
\footnotetext{Author's aggregation. Hyperscaler channel: Big-Four CY2025 actual plus CY2026 guidance times AI share, extended 2027--2030 at roughly flat dollar levels. Take-or-pay: Oracle--OpenAI \$300B + Anthropic--AWS \$100B + Anthropic--Google \$55B + Nebius--Meta \$27B + Nebius--Microsoft \$19B + miscellaneous \$50B. Neocloud debt: CoreWeave \$15--20B + Applied Digital \$2.15B + estimated \$100B capex-pledged facilities across Nebius, Crusoe, Lambda, Fluidstack, Nscale, Voltage Park, Together AI. Sovereign: MGX \$100--200B committed per OpenAI Stargate announcement + HUMAIN \$10B AMD JV + UK DSIT £5B + RIL estimated \$30--50B Jamnagar phase-one.}
...
\textbf{84\% of the 50.6~GW raw horizon is not yet operational; probability-weighted expected realization by 2030 is approximately 36~GW, of which roughly 78\% is not yet operational today.} The build-out is therefore a forward execution bet, not an in-place compute base. The principal risks are concentrated in four categories: grid interconnection, chip delivery, counterparty concentration, and the realisation of outer-year stretch targets (particularly Meta Hyperion, Reliance Jamnagar, and the Anthropic--Amazon full 5~GW). Each is priced into the stress-scenario matrix in \S\ref{subsec:stress-matrix}.

\subsection{Confidence decomposition of the 2030 horizon}

Of the 50.6~GW Western horizon, the six-tier evidence split is: \textbf{T1 Operational} 16\% (8.2~GW, 100\% realization), \textbf{T2 Under construction / physically evidenced} 24\% (11.9~GW, 88\% default), \textbf{T3 Firm commercial} 16\% (7.9~GW, 78\% default), \textbf{T4 Announced site-level plan} 32\% (16.3~GW, 58\% default), \textbf{T5 LOI / stretch target} 10\% (5.1~GW, 32\% default), and \textbf{T6 Analyst inference} 2\% (0.3~GW, 25\% default). Probability-weighted sum across the six tiers yields approximately \textbf{36.1~GW} as the expected 2030 realization --- materially below the 50.6~GW announced horizon and materially above the 27.8~GW conservative case (T1+T2+T3 only).
...
\begin{axis}[
  ...
  ytick=data,
  yticklabels={Western horizon 50.6 GW},
  xlabel={GW},
  xlabel style={font=\small,color=softGrey},
  yticklabel style={font=\small,color=inkBlack},
  xticklabel style={font=\small,color=softGrey},
...
\addplot[fill=accentSage,draw=white] coordinates {(7.76,horizon)};
\addlegendentry{T1 Operational (prob=1.00)}
\addplot[fill=chartG,draw=white] coordinates {(12.32,horizon)};
\addlegendentry{T2 Under construction (prob=0.88)}
\addplot[fill=chartA,draw=white] coordinates {(7.90,horizon)};
\addlegendentry{T3 Firm commercial (prob=0.78)}
\addplot[fill=accentOchre,draw=white] coordinates {(16.28,horizon)};
\addlegendentry{T4 Announced site plan (prob=0.58)}
\addplot[fill=accentTerracotta,draw=white] coordinates {(5.09,horizon)};
\addlegendentry{T5 LOI / stretch target (prob=0.32)}
\addplot[fill=chartE,draw=white] coordinates {(1.25,horizon)};
\addlegendentry{T6 Analyst inference (prob=0.25)}
\end{axis}
\end{tikzpicture}
\caption{Distribution of the 50.6~GW Western horizon across six evidence tiers. Per-tier realization probability is the tier-default midpoint with per-row override possible; see \texttt{CONFIDENCE\_DECOMPOSITION.md} for tier definitions and per-row \texttt{realization\_probability} in the overlay YAML. Probability-weighted sum across the six tiers = approximately \textbf{36.1~GW} (Figure 10B shows the same segments re-scaled by tier-default probability).\protect\footnotemark}
\end{figure}
...
\begin{axis}[
  ...
  symbolic y coords={horizon},
  ytick=data,
  yticklabels={Probability-weighted horizon 36.1 GW},
  xlabel={GW (probability-weighted)},
  xlabel style={font=\small,color=softGrey},
  yticklabel style={font=\small,color=inkBlack},
  xticklabel style={font=\small,color=softGrey},
  xmin=0, xmax=51,
...
\addplot[fill=accentSage,draw=white] coordinates {(7.76,horizon)};
\addlegendentry{T1 $\times$ 1.00 = 7.76}
\addplot[fill=chartG,draw=white] coordinates {(10.84,horizon)};
\addlegendentry{T2 $\times$ 0.88 = 10.84}
\addplot[fill=chartA,draw=white] coordinates {(6.16,horizon)};
\addlegendentry{T3 $\times$ 0.78 = 6.16}
\addplot[fill=accentOchre,draw=white] coordinates {(9.44,horizon)};
\addlegendentry{T4 $\times$ 0.58 = 9.44}
\addplot[fill=accentTerracotta,draw=white] coordinates {(1.63,horizon)};
\addlegendentry{T5 $\times$ 0.32 = 1.63}
\addplot[fill=chartE,draw=white] coordinates {(0.31,horizon)};
\addlegendentry{T6 $\times$ 0.25 = 0.31}
\end{axis}
\end{tikzpicture}
\caption{Figure 10B. Same six tiers as Figure 10, with each segment re-scaled by its tier-default realization probability. The expected 2030 Western realization is approximately \textbf{36.1~GW} --- the right-hand edge of the stacked bar. This is our base case. The T1+T2+T3 conservative subset (7.76 + 10.84 + 6.16 = 24.8~GW expected, or 27.8~GW announced) sits as the bear reading; the 53.5~GW arithmetic ceiling as the bull. Rev-2 (2026-04-24): Stargate Abilene 0.40~GW moved from T1 to T2; aggregate probability-weighted horizon drops by 0.05~GW (within rounding).}
\end{figure}

\subsection{Scenario ranges: 45.7 GW bear to 53.5 GW bull}

Stripping the stretch-target-only tier and compressing speculative completions yields a defensible bear reading of approximately \textbf{45.7 GW}. Realising every stretch on disclosed timeline yields a bull reading of approximately \textbf{53.5 GW}. The base of 50.6 GW sits closer to the bull end because most overlay commitments have primary-source GW floors rather than zero floors.
...
The 50.6~GW announced horizon, 36.1~GW probability-weighted horizon, and 27.8~GW conservative horizon are single-path point estimates. The more decision-relevant question is: which individual mechanisms, if they realize, materially move any of those numbers? We identify five named stress scenarios, each with an estimated GW impact, a capex-envelope impact, named counterparties most exposed, and an assigned probability.
...
\begin{tabular}{@{}lr@{}}
\toprule
\textbf{Percentile of 2030 realized GW} & \textbf{GW} \\
\midrule
p05 (5th percentile) & 22.6 \\
p10 & 24.0 \\
p25 & 26.8 \\
p50 (median) & 31.2 \\
p75 & 34.7 \\
...
\bottomrule
\end{tabular}
\caption{Monte Carlo distribution of the 2030 Western realized horizon, 10{,}000 draws. Seed 20260424, rev-2 post-Epoch-2026-04-22 (T1=7.76, T2=12.32). \textbf{The sim median (31.2~GW) sits approximately 5~GW below the tier-deterministic 36.1~GW} because the stress-scenario stack has negative expected value: A+B+C+D together carry an unconditional expected GW loss of approximately $-5.9$~GW ($-3.5 \cdot 0.30 - 2.0 \cdot 0.25 - 8.0 \cdot 0.40 - 1.5 \cdot 0.50$). Readers treating the deterministic 36.1~GW as central estimate should shift that estimate down by roughly a factor of 5~GW to recover a true probability-honest central value. The rev-2 T1-to-T2 reclassification moves the median from 31.3 to 31.2~GW (within rounding).}
\end{table}

\textbf{Tail probabilities from the sim:}
\begin{itemize}\itemsep0pt
\item $P(\text{realized 2030 GW} < 27.8$ conservative case$) \approx 30\%$
\item $P(\text{realized 2030 GW} < 36.1$ tier-deterministic$) \approx 86\%$
\item $P(\text{realized 2030 GW} < 45.7$ bear arithmetic$) = 100\%$
\item $P(\text{realized 2030 GW} < 50.6$ announced horizon$) = 100\%$
\end{itemize}

The reader's practical takeaway: \textbf{our base case should be a Monte Carlo median of approximately 31~GW with a p10--p90 interdecile range of $[24, 37]$~GW}, not the naive tier-weighted 36.1~GW point. The announced 50.6~GW and the bear 45.7~GW are both above the full simulation's p95 --- no scenario-plausible distribution realizes either figure. The conservative 27.8~GW T1+T2+T3 case is a p30 event: plausible but not central. An LP stress-testing this forecast should focus on the p10 (24~GW) as the stressed-but-plausible reading, not on the announced horizon or the tier-deterministic point.

% ============================================================================
\section{Sovereign AI}
% ============================================================================

The sovereign-AI pipeline is reported separately from the Western-aligned horizon because state-backed programmes operate under different financing, revenue-model, and timeline dynamics. Four programmes dominate the 2030 sovereign pipeline, each labeled with its evidence tier and realization probability on the same 6-tier framework applied to the Western denominator: \textbf{UAE G42-Khazna / Stargate UAE} --- Phase 1 200~MW \textbf{(T1 operational, prob=1.00)}; expansion to 1~GW by 2030 \textbf{(T4 announced, prob=0.70)}. \textbf{Saudi HUMAIN--AMD} --- 500~MW over 5 years \textbf{(T4, prob=0.55)}. \textbf{Saudi HUMAIN--xAI} --- 500~MW JV, Phase 1 cluster \textbf{(T4, prob=0.55)}. \textbf{UK Culham AI Growth Zone} --- 500~MW by 2030, initial 100--250~MW by 2027 \textbf{(T5 stretch, no anchor tenant disclosed yet, prob=0.30)}. \textbf{India Reliance Jamnagar} --- Phase 1 120~MW H2 2026 \textbf{(T1--T2, prob=0.95)}; ``gigawatt-scale'' AGM target \textbf{(T5 stretch, prob=0.20)}. \textbf{Sovereign sum: 1.95~GW announced, 0.69~GW probability-weighted.} This 1.95~GW is not additive to the Western 50.6~GW denominator.
...
Sovereign programs disclose less than Western hyperscalers and lab counterparties. UAE G42-Khazna uses press-release granularity; Saudi HUMAIN-AMD operates behind confidential PIF-AMD JV terms; India Reliance Jamnagar disclosure is limited to AGM oratory and the 47th AGM Chairman Statement. The \$1.95~GW sovereign sidebar in this paper is the disclosed floor, not the commissioned ceiling. A doubling or tripling of sovereign build intent in 2027--2028 is plausible and is the largest upside surprise not priced into the Western horizon.
...
\noindent \textbf{Reconciliation to headline totals.} The overlay incremental total of 20.1 GW combines with Epoch's 33.05 GW physically-evidenced floor and the neocloud-ex-Epoch cross-allocation to yield the 50.6~GW Western 2030 horizon cited throughout the paper. The sovereign 1.95~GW (Microsoft/G42, AMD/HUMAIN, Reliance, UK Culham) is reported separately in \S8 and is not included in the Western denominator.
