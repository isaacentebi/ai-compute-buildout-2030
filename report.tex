...
\textcolor{softGrey}{2.} & Geographic concentration & 6 \\
\textcolor{softGrey}{3.} & The operators: who owns the horizon & 7 \\
\textcolor{softGrey}{4.} & The silicon: NVIDIA, Trainium, TPU, AMD, Broadcom, MTIA & 11 \\
\textcolor{softGrey}{5.} & The \$1.5 trillion question: where the money comes from & 13 \\
\textcolor{softGrey}{6.} & The counterparty graph & 17 \\
\textcolor{softGrey}{7.} & Execution risk: what breaks the build-out & 18 \\
\textcolor{softGrey}{8.} & Sovereign AI & 22 \\
\textcolor{softGrey}{9.} & Known unknowns & 23 \\
\textcolor{softGrey}{10.} & Conclusion & 25 \\
\textcolor{softGrey}{A.} & Appendix: data sources and methodology & 27 \\
\textcolor{softGrey}{B.} & Appendix: row-level audit (summary) & 29 \\
\end{tabular}
\end{spacing}
