...
\textbf{Where this section ends and the next begins.} Section~\ref{sec:scale} states the headline aggregates --- 7.56~GW operational, 51.9~GW raw 2030 horizon, 31.8~GW Monte~Carlo median, approximately \$1.9~trillion capital envelope, 78.2~million H100-equivalents. These are scale numbers, multiplications. Before scaling, the multiplicand. The next section decomposes one AI facility gigawatt into its physical bill of materials so every aggregate downstream resolves to a unit that has been priced, assembled, and reconciled to the external literature. We then return in Section~\ref{sec:scale-body} to the power-unit conventions, the compute-versus-physical-capacity bridge, and the operator concentration on which the headline numbers rest.
...
Out-of-rack networking & 2.5 & 5.0 & 4.0 & Optics (60\% of out-of-rack BOM); back-end fabric \\
...
\textbf{Subtotal: IT BOM at customer} & \textbf{19} & \textbf{28.5} & \textbf{24.0} & Accel + server + out-of-rack networking + storage \\
