...
| source URL verified | WARN | verified_ok=90; redirected_verified=3; blocked_manual_review=33; failed=7; replaced=2. |
| blocked URLs | WARN | 33 blocked/manual-review URLs listed in `url_check_report.json`. |
| redirects | WARN | 3 redirects listed with `final_url` and content-validation status. |
