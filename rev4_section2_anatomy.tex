...
\textbf{Why a unit primitive.} Section~\ref{sec:scale} reports the headline aggregates: 7.56~GW operational, 51.9~GW raw 2030 horizon, 31.8~GW Monte~Carlo median, approximately \$1.9~trillion capital envelope, 78.2~million H100-equivalents. These quantities are scale numbers --- multiplications. The multiplicand is a single facility gigawatt of AI compute, and the answers to four small questions about that unit set the credibility of every aggregate downstream:
